...
| `BLOG_MASS_CHANGE_LIMIT` | `max(10, 20% of tracked posts)` | scrape | Blog guard: abort when added/updated posts exceed this value in one run. Set a higher number to allow a legit mass update. |
