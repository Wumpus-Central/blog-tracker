<p>Joining a new server is an exciting experience, but sometimes it can be overwhelming to familiarize yourself with all the different channels and rules. To help new members with their onboarding experience, admins can now add a <strong>Server Guide</strong>.  </p>
...
<ul>
<li>
<strong>Welcome Sign</strong>: a space at the top of Server Guide where you can write a custom message from you, the admin.</li>
<li>
<strong>New Member To Do’s: </strong>3-5 tasks for your new members that help them get started talking and engaging in your channels.</li>
<li>
