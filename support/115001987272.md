...
<li>
<strong>Server Two-Factor Authentication: </strong>Prevent potentially dangerous administrative actions for users without two-factor authentication enabled.</li>
</ul>
