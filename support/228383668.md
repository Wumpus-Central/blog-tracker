...
<li>
<strong>Choose what channel the Webhook posts to:</strong> By selecting the desired text channel in the  dropdown menu.</li>
<li>
<strong>Name your Webhook: </strong>Good for distinguishing multiple webhooks for multiple different services.</li>
</ul>
