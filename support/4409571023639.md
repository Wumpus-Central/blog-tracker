<h3>
<strong>Note:<br></strong>- You can only manage icons on the desktop version of the app at this time. <br>- Only server members who have the “Manage Roles” permission will be able to set, change, and delete icons.</h3>
...
<h3>
<strong>Note:</strong> The requirements for the images are 64x64 pixels and the max size is 256kb.</h3>
