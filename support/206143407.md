<p>Want to prevent outsiders from being able to view all the channels on your server? If so, you're in the right place as this article covers the steps for setting up a "private" server.</p>
